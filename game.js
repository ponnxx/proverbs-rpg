  ...
  // =========================
  {
    ...
    questions:[
...

      {
        ...
        `,
        choices:[
          [`「まだ おこってるから、${R('許','ゆる')}さない」と いう`,false],
          [`「いいよ。つぎからは ${R('使','つか')}うまえに ${R('聞','き')}てね」と いう`,true],
    ...
    questions:[
...

      {
        ...
        choices:[
          ...
          [`${R('答','こた')}えを すぐに ${R('決','き')}めて、あとで ${R('考','かんが')}える`,false],
          [`${R('教','おし')}えてもらったことを ${R('考','かんが')}えて、${R('正','ただ')}しいことを えらぶ`,true]
        ]
      }
    ],
    ...
    questions:[
...

      {
        ...
        choices:[
          ...
          [`どちらも ${R('嫌','いや')}なので、なにも しない`,false]
        ]
      }
    ],

    msg:`
      いのって ${R('主','しゅ')}を ${R('信頼','しんらい')}すると、
      ${R('道','みち')}が ${R('見','み')}えてくるよ。
    `,
